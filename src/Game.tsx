...
export const Game: React.FC<{}> = () => {
  ...
  interface CustomWindow extends Window {
    starting?: any; // Replace 'any' with the actual type of starting if known
    solved?: any; // Replace 'any' with the actual type of solved if known
  }
  ...
  function _createNewGame(e?: React.ChangeEvent<HTMLSelectElement>) {
    let [temporaryInitArray, temporarySolvedArray] =
      (window as CustomWindow).starting && (window as CustomWindow).solved
        ? [(window as CustomWindow).starting, (window as CustomWindow).solved]
